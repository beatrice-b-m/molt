...
import type { Cell as CellType, CellOutput } from "../types/notebook";
import { useNotebookStore } from "../store/notebookStore";
import { ensureKernel, executeCell, interruptKernel } from "../hooks/useKernel";
...
// ---------------------------------------------------------------------------
// Exported execution function — used by Cell's run button and by Toolbar
// ("run all cells").
// ---------------------------------------------------------------------------
